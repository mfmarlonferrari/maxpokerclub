...
config.set("max_connections_per_ip",	1);			// limit for connections per IP
...
config.set("welcome_message",		"Seja bem-vindo ao Vale Do Poker. Bons jogos!"); // welcome message sent on state info
